...
from Model.WorldObjects import Pitch, CT_YELLOW_ROBOT, CT_BLUE_ROBOT, CT_BALL, CT_YELLOW_KICKER, CT_LEFT_GOAL, CT_RIGHT_GOAL
from Drawing.Drawing import green
