...
# Real speed in pixel/s taking account of all the delays and wobbling 
#    TODO: tweak and change to cm/s and use LocalFuncs.py from strategy to convert 
Params.robotRealSpeed = 40
Params.predictionCircleCenter = 20
